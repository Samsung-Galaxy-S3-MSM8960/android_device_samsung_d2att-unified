...
$(call inherit-product-if-exists, vendor/omni/config/common_full_phone.mk)
...
BUILD_FINGERPRINT := samsung/omni_d2att/d2att:9/I747UCUFNJ2/alexenferman:userdebug/release-keys
